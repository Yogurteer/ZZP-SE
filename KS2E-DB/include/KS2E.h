...
public:
    ...
    int trapdoor_w(vector<unsigned char> w, vector<vector<unsigned char>>& Tw);

    int trapdoor_id(vector<unsigned char> id, vector<vector<unsigned char>>& Tid);

    vector<vector<unsigned char>> dec_result_w(vector<unsigned char> w, vector<vector<unsigned char>> S);
